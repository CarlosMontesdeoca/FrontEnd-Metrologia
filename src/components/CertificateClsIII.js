...
export default function CertificateClsIII({data, user}) {
  ...
  if (data.certificate) {
    return(
      <section className="cam">
        <h3 class="text-center"> HOJA DE CÁLCULO PARA BALANZA CLASE III (tres).</h3>
        <br/>
          ...
          <div className="col">
            <table className="table table-sm table-bordered">
              <tbody className="txcenter">
                ...
                <tr>
                <th title="Capacidad de Uso en u">Cap. Uso [U]</th>
        ...
        <table className="table table-bordered table-sm">
          <tbody className="txcenter">
            ...
            <tr>
              <th title="Carga en u"> Carga [U] </th>
              <th> Indicación </th>
              <th> Pos 1 </th>
              <th> Pos 2 </th>
              <th> Pos 3 </th>
              <th> Pos 4 </th>
              <th> Pos 5 </th>
              <th title="Excentricidad Máxima"> Exct. máx. </th>
            ...
            <tr>
              ...
              <th title="Incertidumbre de Excentricidad" colspan="4"> <b> w(Exc)= </b><span style={{color: "#11801e"}}> -- Data!--</span></th>
              <td> --Data!-- </td>
              <td> --Data!-- </td>
              <td> --Data!-- </td>
            </tr>
        ...
        <table className="table table-bordered table-sm">
          <tbody className="txcenter">
            ...
            <tr>
              ...
              <th>µ(rept) = <span style={{color: "#11801e"}}> -- Data!--</span></th>
              <td>--Data!--</td>
              <td>--Data!--</td>
              <td>--Data!--</td>
            </tr>
        ...
        <table className="table table-bordered table-sm">
          <tbody className="txcenter">
            ...
            <tr>
              <th>N°</th>
              <th title="Carga Nominal en u">Carga Nominal [U]</th>
              ...
              <th title="Evaluación de la Prueba">Cumplimiento</th>
              <th title="Incertidumbre de Histéresis en u.">Incertidumbre de Histéresis [U]</th>
        ...
        <table className="table table-sm table-bordered">
          <tbody className="txcenter">
            <tr>
              <th colspan="7" className="bg-primary head">INCERTIDUMBRE DEL PATRÓN</th>
            </tr>
            <tr>
              <th>Carga</th>
              <th>µ(pat)</th>
